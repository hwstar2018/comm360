# Docker configuration for Comm360 Microservices

This folder containing scripts and Docker Compose configurations to run Comm360 in Microservices mode.

## Prerequisites

Comm360 Microservices are running in dockerized environment.
Before starting please make sure [Docker CE](https://docs.docker.com/install/) and [Docker Compose](https://docs.docker.com/compose/install/) are installed in your system.

## Installation

Before performing initial installation you can configure the type of database to be used with Comm360.
...
You should see Comm360 login page.
...
For example to see Comm360 node logs execute the following command:
...
- `FROM_VERSION` - from which version upgrade should be started. See [Upgrade Instructions](https://comm360.com/docs/user-guide/install/upgrade-instructions) for valid `fromVersion` values.
