...
public abstract class BaseUserServiceTest extends AbstractServiceTest {
    ...
    public void before() {
        ...
        tenantAdmin.setEmail("tenant@comm360.com");
        ...
        customerUser.setEmail("customer@comm360.com");
    ...
    public void testFindUserByEmail() {
        User user = userService.findUserByEmail(SYSTEM_TENANT_ID, "sysadmin@comm360.com");
        Assert.assertNotNull(user);
        Assert.assertEquals(Authority.SYS_ADMIN, user.getAuthority());
        user = userService.findUserByEmail(tenantId, "tenant@comm360.com");
        Assert.assertNotNull(user);
        Assert.assertEquals(Authority.TENANT_ADMIN, user.getAuthority());
        user = userService.findUserByEmail(tenantId, "customer@comm360.com");
        Assert.assertNotNull(user);
        Assert.assertEquals(Authority.CUSTOMER_USER, user.getAuthority());
        user = userService.findUserByEmail(tenantId, "fake@comm360.com");
    ...
    public void testSaveUser() {
        User tenantAdminUser = userService.findUserByEmail(SYSTEM_TENANT_ID,"tenant@comm360.com");
        User user = new User();
        user.setAuthority(Authority.TENANT_ADMIN);
        user.setTenantId(tenantAdminUser.getTenantId());
        user.setEmail("tenant2@comm360.com");
    ...
    public void testSaveUserWithSameEmail() {
        User tenantAdminUser = userService.findUserByEmail(tenantId, "tenant@comm360.com");
        tenantAdminUser.setEmail("sysadmin@comm360.com");
    ...
    public void testSaveUserWithInvalidEmail() {
        User tenantAdminUser = userService.findUserByEmail(tenantId, "tenant@comm360.com");
        tenantAdminUser.setEmail("tenant@comm360.com");
        userService.saveUser(tenantAdminUser);
    }
    ...
    public void testFindTenantAdmins() {
        ...
        for (int i = 0; i < 124; i++) {
            ...
            user.setEmail("testTenant" + i + "@comm360.com");
    ...
    public void testFindTenantAdminsByEmail() {
        ...
        for (int i = 0; i < 94; i++) {
            ...
            String email = email1 + suffix + "@comm360.com";
        ...
        for (int i = 0; i < 132; i++) {
            ...
            user.setTenantId(tenantId);
            String suffix = StringUtils.randomAlphanumeric((int) (5 + Math.random() * 10));
            String email = email2 + suffix + "@comm360.com";
            email = i % 2 == 0 ? email.toLowerCase() : email.toUpperCase();
            user.setEmail(email);
    ...
    public void testFindCustomerUsers() {
        User customerUser = userService.findUserByEmail(tenantId, "customer@comm360.com");
        ...
        for (int i = 0; i < 156; i++) {
            ...
            user.setEmail("testCustomer" + i + "@comm360.com");
